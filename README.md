...
This is the backend for the Play application, built with [NestJS](https://nestjs.com).
...
The server will typically run on [http://localhost:3000](http://localhost:3000) (or as configured).
